...
card_name=['Royal Delivery','Giant Snowball','Heal Spirit','Furnace','Goblin Cage','Goblin Drill','Arrows','Fireball','Rage','Rocket','Goblin Barrel','Freeze','Mirror','Lightning','Zap','Poison','Graveyard','The Log','Tornado','Clone','Earthquake','Barbarian Barrel','X-Bow','Tombstone']
...
# Create a new window to display the images
    ...
    # Variable to track the number of displayed rows
    

    # Iterate over the keys and image URLs in the cards_map
    for card_name, image_url in cards_map.items():
        ...
        label4 = tk.Label(image_window, text="Recomiendo usar este mazo:")
