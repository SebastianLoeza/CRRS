...
card_namex=['Royal Delivery','Giant Snowball','Heal Spirit','Furnace','Goblin Cage','Goblin Drill','Arrows','Fireball','Rage','Rocket','Goblin Barrel','Freeze','Mirror','Lightning','Zap','Poison','Graveyard','The Log','Tornado','Clone','Earthquake','Barbarian Barrel','X-Bow','Tombstone']
